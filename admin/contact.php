    ...
    <div class="container mx-auto px-6 md:px-12 lg:px-24 py-8">
        ...
        <div id="social-section" class="admin-card" data-aos="fade-up-slow">
            ...
            <div class="section-header flex justify-between items-center"
                onclick="toggleSection('social-content')">
            ...
            <div id="social-content" class="section-content p-6">
                ...
                <!-- Add New Social Link -->
                <form method="POST" class="mb-6 p-4 bg-gray-50 rounded-lg shadow-sm">
                    <h3 class="text-lg font-semibold mb-4 text-[#0F2854]">
                        Add New Social Link
                    </h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text"
                                name="icon"
                                placeholder="e.g., fa-linkedin-in"
                                class="form-input"
                                required>
                        </div>

...
<nav class="bg-white border-b border-gray-100 sticky top-0 z-50 py-4" data-aos="fade-down-slow"
    ...
    <div class="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24">
        <div class="flex justify-between items-center">
            ...
            <div class="hidden 2xl:flex items-center space-x-8 mx-4">
                <div class="flex items-center space-x-8">
                    <a href="/index.php" class="nav-link text-gray-700 font-medium hover:text-[#D4AF37] transition duration-300 text-base whitespace-nowrap">Home</a>
                    <a href="/pages/overview.php" class="nav-link text-gray-700 font-medium hover:text-[#D4AF37] transition duration-300 text-base whitespace-nowrap">About Us</a>
                    <a href="/pages/team.php" class="nav-link text-gray-700 font-medium hover:text-[#D4AF37] transition duration-300 text-base whitespace-nowrap">Our Partner</a>
                    <a href="/pages/expertise.php" class="nav-link text-gray-700 font-medium hover:text-[#D4AF37] transition duration-300 text-base whitespace-nowrap">Services</a>
                    <a href="/pages/jurisprudence.php" class="nav-link text-gray-700 font-medium hover:text-[#D4AF37] transition duration-300 text-base whitespace-nowrap">Landmark Cases</a>
            ...
            <div class="hidden xl:flex 2xl:hidden items-center space-x-6">
                <div class="flex items-center space-x-6">
                    <a href="/index.php" class="nav-link text-gray-700 font-medium hover:text-[#D4AF37] transition duration-300 text-sm whitespace-nowrap">Home</a>
                    <a href="/pages/overview.php" class="nav-link text-gray-700 font-medium hover:text-[#D4AF37] transition duration-300 text-sm whitespace-nowrap">About Us</a>
                    ...
                    <a href="/pages/expertise.php" class="nav-link text-gray-700 font-medium hover:text-[#D4AF37] transition duration-300 text-sm whitespace-nowrap">Services</a>
                    <a href="/pages/jurisprudence.php" class="nav-link text-gray-700 font-medium hover:text-[#D4AF37] transition duration-300 text-sm whitespace-nowrap">Landmark Cases</a>
        ...
        <div id="tablet-menu" class="menu-panel hidden md:block lg:hidden overflow-hidden transition-all duration-300 ease-in-out max-h-0 opacity-0">
            <div class="py-4 border-t border-gray-100 mt-3">
                <div class="grid grid-cols-2 gap-3">
                    <a href="/index.php" class="menu-link text-gray-700 font-medium hover:text-[#D4AF37] transition py-3 px-3 text-center bg-gray-50 rounded-lg">Home</a>
                    <a href="/pages/overview.php" class="menu-link text-gray-700 font-medium hover:text-[#D4AF37] transition py-3 px-3 text-center bg-gray-50 rounded-lg">About Us</a>
                    <a href="/pages/team.php" class="menu-link text-gray-700 font-medium hover:text-[#D4AF37] transition py-3 px-3 text-center bg-gray-50 rounded-lg">Our Partner</a>
                    <a href="/pages/expertise.php" class="menu-link text-gray-700 font-medium hover:text-[#D4AF37] transition py-3 px-3 text-center bg-gray-50 rounded-lg">Services</a>
                    <a href="/pages/jurisprudence.php" class="menu-link text-gray-700 font-medium hover:text-[#D4AF37] transition py-3 px-3 text-center bg-gray-50 rounded-lg">Landmark Cases</a>
        ...
        <div id="mobile-large-menu" class="menu-panel hidden sm:block md:hidden overflow-hidden transition-all duration-300 ease-in-out max-h-0 opacity-0">
            <div class="py-4 border-t border-gray-100 mt-3">
                <div class="flex flex-col space-y-3">
                    <a href="/index.php" class="menu-link text-gray-700 font-medium hover:text-[#D4AF37] transition py-2 px-2 text-base">Home</a>
                    <a href="/pages/overview.php" class="menu-link text-gray-700 font-medium hover:text-[#D4AF37] transition py-2 px-2 text-base">About Us</a>
                    <a href="/pages/team.php" class="menu-link text-gray-700 font-medium hover:text-[#D4AF37] transition py-2 px-2 text-base">Our Partner</a>
                    <a href="/pages/expertise.php" class="menu-link text-gray-700 font-medium hover:text-[#D4AF37] transition py-2 px-2 text-base">Services</a>
                    <a href="/pages/jurisprudence.php" class="menu-link text-gray-700 font-medium hover:text-[#D4AF37] transition py-2 px-2 text-base">Landmark Cases</a>
        ...
        <div id="mobile-small-menu" class="menu-panel block sm:hidden overflow-hidden transition-all duration-300 ease-in-out max-h-0 opacity-0">
            <div class="py-4 border-t border-gray-100 mt-3">
                <div class="flex flex-col space-y-3">
                    <a href="/index.php" class="menu-link text-gray-700 font-medium hover:text-[#D4AF37] transition py-2 px-2 text-sm">Home</a>
                    <a href="/pages/overview.php" class="menu-link text-gray-700 font-medium hover:text-[#D4AF37] transition py-2 px-2 text-sm">About Us</a>
                    <a href="/pages/team.php" class="menu-link text-gray-700 font-medium hover:text-[#D4AF37] transition py-2 px-2 text-sm">Our Partner</a>
                    <a href="/pages/expertise.php" class="menu-link text-gray-700 font-medium hover:text-[#D4AF37] transition py-2 px-2 text-sm">Services</a>
                    <a href="/pages/jurisprudence.php" class="menu-link text-gray-700 font-medium hover:text-[#D4AF37] transition py-2 px-2 text-sm">Landmark Cases</a>
